...
import { EducationTimeline } from '@/components/cv/education-timeline';
import { HighlightsCards } from '@/components/cv/highlights-cards';
import { PublicationGrid } from '@/components/cv/publication-grid';
import { ResearchOverview } from '@/components/cv/research-overview';
import { TeachingList } from '@/components/cv/teaching-list';
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className="pb-20">
        <HighlightsCards locale={locale} />
        <EducationTimeline locale={locale} />
        <ResearchOverview locale={locale} />
        <TeachingList locale={locale} />
        <PublicationGrid locale={locale} />
      </div>
    </>
  );
}
